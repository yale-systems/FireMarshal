...
#define IOCACHE_IOCTL_RESERVE_RING _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 11, __u64)

#define IOCACHE_IOCTL_FREE_RING _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 12, __u64)
