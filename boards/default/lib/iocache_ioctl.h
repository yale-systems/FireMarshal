...
#define IOCACHE_IOCTL_GET_LAST_IRQ_NS _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 3, __u64)

#define IOCACHE_IOCTL_WAIT_TIMEOUT _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 4, int)

#define IOCACHE_IOCTL_GET_KTIMES _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 5, __u64)

#define IOCACHE_IOCTL_GET_PROC_UTIL _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 6, __u64)

#define IOCACHE_IOCTL_RESERVE_RING _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 7, __u64)

#define IOCACHE_IOCTL_FREE_RING _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 8, __u64)

#define IOCACHE_IOCTL_START_SCHEDULER _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 9, __u64)
