...
#define IOCACHE_IOCTL_GET_KTIMES _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 6, __u64)

#define IOCACHE_IOCTL_GET_PROC_UTIL _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 7, __u64)

#define IOCACHE_IOCTL_GET_AVAIL_RING _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 8, __u64)

#define IOCACHE_IOCTL_RUN_SCHEDULER _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 9, __u64)

#define IOCACHE_IOCTL_STOP_SCHEDULER _IOR(IOCACHE_IOCTL_TYPE, IOCACHE_IOCTL_BASE + 10, __u64)
